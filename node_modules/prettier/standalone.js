(function (e) {
  ...
  var pr = we((i0, Ju) => {
    ...
    Ju.exports = function (e, n) {
      try {
        ll(Gu, e, { value: n, configurable: !0, writable: !0 });
      } catch {
        Gu[e] = n;
      }
      return n;
  ...
  var os = we((D0, as) => {
    ...
    as.exports = function (e, n) {
      ...
      if (t) {
        if (
          (n === void 0 && (n = "default"), (s = Nl(t, e, n)), !ss(s) || is(s))
        )
          return s;
    ...
    gi.exports = function (e, n) {
      ...
      if (
        ...
        for (i in n) {
          if (
            ((c = n[i]),
            e.noTargetGet ? ((v = hp(u, i)), (o = v && v.value)) : (o = u[i]),
  ...
  var Pg = we((my, Co) => {
    ...
    var tD = Object.create,
      ...
      Z = (e, n) =>
        function () {
          return (
            n || (0, e[In(e)[0]])((n = { exports: {} }).exports, n), n.exports
          );
        },
      Ut = (e, n) => {
      ...
      lt = (e) => ga(Br({}, "__esModule", { value: !0 }), e),
      pa,
      fa,
      Tt,
      re = mt({
        ...
        "node_modules/diff/lib/diff/base.js"(e) {
          ...
          n.prototype = {
            ...
            extractCommon: function (r, u, i, o) {
              for (
                var c = u.length, v = i.length, m = r.newPos, d = m - o, p = 0;
...
`)
      ...
      yD = Z({
        "src/document/doc-printer.js"(e, n) {
          ...
          function w(B, I, k) {
            let P =
                I.type === "dedent" ? B.queue.slice(0, -1) : [...B.queue, I],
              C = "",
              D = 0,
              g = 0,
              F = 0;
...
`
                ...
                switch (x.type) {
                  ...
                  case "line-suffix":
                    ...
                    break;
                  case "line-suffix-boundary":
                    l.length > 0 && D.push([y, N, { type: "line", hard: !0 }]);
                    break;
                  case "line":
                    switch (N) {
                      case d:
                      ...
                      case m:
                        ...
                        x.literal
                          ? y.root
                            ...
                            : (g.push(P), (C = 0))
                          : ((C -= T(g)), g.push(P + y.value), (C = y.length));
                        break;
                    }
                    break;
                  case "label":
          ...
          function w(A) {
            ...
            function I(P) {
              ...
              if (h(P)) {
                var g = P,
                  F =
                    (C[0] === I || C[0] === T) && d.test(g[0]) && v.test(g[1]),
                  l = F ? B : S,
                  E = l.get(g);
...
`);
          ...
          e.levenUnknownHandler = (s, a, r) => {
            let { descriptor: u, logger: i, schemas: o } = r,
              ...
              v = Object.keys(o)
                .sort()
                .find((m) => t(s, m) < 3);
            v && c.push("Did you mean ".concat(n.default.blue(u.key(v)), "?")),
              i.warn(c.join(" "));
          };
        },
      }),
          ...
          var s = class {
            ...
            _applyNormalization(a, r) {
              ...
              for (let c of i) {
                      ...
                      if (B === !0)
                        ...
                        for (let { value: I } of B) {
                          ...
                          if (!this._hasDeprecationWarned(k)) {
                            let P =
                              typeof S == "string" ? { key: S, value: I } : S;
                            this._utils.logger.warn(
                ...
                t.normalizeForwardResult(v.forward(m, this._utils), m).forEach(
                  p
                );
              ...
              S = w
                ...
                : (D, g, F) => {
                    ...
                    return t.levenUnknownHandler(
                      D,
                      g,
                      Object.assign(Object.assign({}, F), {}, { schemas: y })
                    );
                  },
          ...
          function u(o, c) {
            let v =
                arguments.length > 2 && arguments[2] !== void 0
                  ...
                  : {},
              m =
                (v.highlightCode || v.forceColor) && (0, n.shouldHighlight)(v),
              d = (0, n.getChalk)(v),
              p = s(d),
              f = (P, C) => (m ? P(C) : C),
              h = o.split(a),
 ...
 `,
                        ...
                        E && v.message && (y += " " + f(p.message, v.message));
                    }
                    return [
                      f(p.marker, ">"),
                      f(p.gutter, F),
...
`
          ...
          function i(o, c, v) {
            ...
            return (
              (v = Math.max(v, 0)), u(o, { start: { column: v, line: c } }, m)
            );
          }
        },
      }),
          ...
          function o(m) {
            ...
            let A = Object.fromEntries(
                f
                  .filter(
                    (B) =>
                      B.pluginDefaults && B.pluginDefaults[T.name] !== void 0
                  )
            ...
            return {
              ...
              options: k(
                ...
                Object.assign(
                  Object.assign({}, F),
                  {},
                  { cursorOffset: l, rangeStart: E, rangeEnd: y, endOfLine: N }
                )
              ),
            };
          }
                  ...
                  if (De($e)) {
                    ...
                    for (; De(Je); )
                      if (
                        ...
                        return !1;
                    return (
                      Je.type === "Identifier" || Je.type === "ThisExpression"
                    );
                  }
                  return !1;
                });
      ...
      Pm = Z({
        "src/language-js/embed/graphql.js"(e, n) {
          ...
          var {
            ...
            { escapeTemplateCharacters: r, printTemplateExpressions: u } = Lt();
          function i(c, v, m) {
            let d = c.getValue(),
              p = d.quasis.length;
...
`),
          ...
          function o(c) {
            ...
            for (let [p, f] of d.entries())
              f !== "" &&
                (d[p - 1] === "" && m ? v.push([a, f]) : v.push(f), (m = !0));
        ...
        "src/language-js/embed/html.js"(e, n) {
          ...
          function v(m, d, p, f, h) {
            ...
            let S = (E) =>
              ...
              B = T.quasis
                .map((E, y, N) =>
                  y === N.length - 1 ? E.value.cooked : E.value.cooked + S(y)
                )
                .join(""),
              I = i(m, d);
...
`);
      ...
      no = Z({
        "src/language-js/pragma.js"(e, n) {
          "use strict";
          re();
          var { parseWithComments: t, strip: s, extract: a, print: r } = Vm(),
      ...
      uo = Z({
        "src/language-js/comments.js"(e, n) {
          ...
          var {
            ...
            E = It();
          function y(me) {
            return [ve, De, q, j, $, V, Q, Ae, U, ge, Ne, ke, te, ie, G].some(
              (_) => _(me)
            );
          }
          function N(me) {
            return [M, De, Y, Ne, j, $, V, Q, ie, z, le, ge, de, G, he].some(
              (_) => _(me)
            );
          }
          function x(me) {
          ...
          function ue(me) {
            ...
            return r(ne, _, l) !== ")"
              ? !1
              : J &&
                ((ye(J) && d(J).length === 0) || (A(J) && S(J).length === 0))
              ? (c(J, _), !0)
          ...
          function w(P, C) {
            ...
            switch (D.type) {
              ...
              case "ArrowFunctionExpression": {
                if (g === "body" && F.type !== "SequenceExpression" && v(F, !1))
                  return !0;
                break;
              }
            }
      ...
      Gm = Z({
        "src/language-js/print/jsx.js"(e, n) {
          ...
          function E(ie, G, z) {
            ...
            let Ce = he ? v(ye) : i(ye, { shouldBreak: !0 });
            if (pe) return Ce;
          ...
          function g(y, N, x, b, L) {
            ...
            if (j.length === 0)
              return [
                $,
                "(",
                s(y, x, !0, (ee) => t(x.originalText, ee, P) === ")"),
                ")",
              ];
      ...
      kr = Z({
        "src/language-js/print/type-annotation.js"(e, n) {
          ...
          var { printComments: t, printDanglingComments: s } = et(),
            ...
            { printFunctionParameters: B, shouldGroupFunctionParameters: I } =
              Pr(),
          ...
          function l(x, b, L) {
            ...
            let Q = B(x, L, b, !1, !0),
              ...
              te = I(M, ee);
            return (
              j.push(te ? r(Q) : Q), ee && j.push(ee), R && j.push(")"), r(j)
            );
          }
          function E(x, b, L) {
            let M = x.getValue(),
      ...
      Lr = Z({
        "src/language-js/print/function.js"(e, n) {
          ...
          var t = Xt(),
            ...
            { locEnd: M } = st(),
            { printFunctionParameters: j, shouldGroupFunctionParameters: $ } =
              Pr(),
          ...
          function R(z, U, le) {
            ...
            return (
              ge.body ? ce.push(" ", le("body")) : ce.push(U.semi ? ";" : ""),
              ce
            );
          }
          ...
          function ue(z, U, le) {
            ...
            ge.argument &&
              (G(U, ge.argument)
                ...
                ? Ne.push(c([m(" (", " "), v([o, le("argument")]), o, m(")")]))
                : Ne.push(" ", le("argument")));
            let ke = l(ge),
              ce = r(ke),
              pe = ce && g(ce);
      ...
      co = Z({
        "src/language-js/print/module.js"(e, n) {
          ...
          var { isNonEmptyArray: t } = Ue(),
            ...
            { hasDecoratorsBeforeExport: S, printDecoratorsBeforeExport: B } =
              Un();
          function I(N, x, b) {
            let L = N.getValue(),
              M = x.semi ? ";" : "",
          ...
          function k(N, x, b) {
            ...
            return (
              ...
              (L.default || j === "ExportDefaultDeclaration") &&
                M.push(" default"),
              m(L, d.Dangling) && (M.push(" ", v(N, x, !0)), f(L) && M.push(c)),
              V
      ...
      Um = Z({
        "src/language-js/print/flow.js"(e, n) {
          ...
          var t = Xt(),
            ...
            { printExportDeclaration: l, printExportAllDeclaration: E } = co(),
      ...
      Xm = Z({
        "src/language-js/print/typescript.js"(e, n) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { printTernary: k } = po(),
            { printFunctionParameters: P, shouldGroupFunctionParameters: C } =
              Pr(),
            ...
            switch (xe.type) {
              ...
              case "IfStatement": {
                ...
                if ((_e.push(Re), xe.alternate)) {
                  ...
                  _e.push(Le ? " " : u),
                    A(xe, S.Dangling) && _e.push(t(Be, Pe, !0), be ? u : " "),
                    _e.push(
                      "else",
                      o(
                        R(
              ...
              case "DoWhileStatement": {
                ...
                return (
                  (_e = [o(["do", je])]),
                  xe.body.type === "BlockStatement" ? _e.push(" ") : _e.push(u),
              ...
              case "SwitchCase": {
                xe.test
                  ...
                  : _e.push("default:"),
                  A(xe, S.Dangling) && _e.push(" ", t(Be, Pe, !0));
...
`
      ...
      cd = Z({
        "src/language-css/utils/index.js"(e, n) {
          ...
          function oe(G) {
            return (
              G.value && ["not", "and", "or"].includes(G.value.toLowerCase())
            );
          }
          function W(G) {
...
` ||
              ...
              case "value-comma_group": {
                ...
                for (let ut = 0; ut < se.groups.length; ++ut) {
                  ...
                  if (
                    ...
                    continue;
                  let Eo =
                      Ve.type === "value-string" && Ve.value.startsWith("#{"),
                    Fo =
                      Je &&
          ...
          function f(S, B) {
            ...
            let D = S.getValue(),
              ...
              F =
                (k =
                  (P =
                    (C = g.children) !== null && C !== void 0 ? C : g.body) !==
                    null && P !== void 0
                    ? P
      ...
      Nd = Z({
        "src/language-handlebars/printer-glimmer.js"(e, n) {
          ...
          function oe(K) {
            return (
              P(K, ["BlockStatement"]) && K.program.body.every((he) => F(he))
            );
          }
          function W(K) {
            return (
...
`
            ...
            if (ce.type === "html")
              ...
              ce.type === "esComment"
                ...
                : ce.type === "paragraph" &&
                  ...
                  (de = ce.children[0]),
                de &&
                  (pe = de.value.match(/^prettier-ignore(?:-(start|end))?$/));
            }
          ...
          function ge(ce) {
            ...
            return new RegExp(de.map((ae) => "\\".concat(ae)).join("|")).test(
              ce
            )
              ? "<".concat(ce, ">")
              : ce;
          ...
          var I = class {
            ...
            addDirective(y) {
              this.directivesSet.has(y.reference) ||
                (this.directivesSet.add(y.reference), this.directives.push(y));
            }
...
`
          ...
          function T(l) {
            let E = (y) =>
              ...
              y.prev.sourceSpan.end.offset === y.startSourceSpan.start.offset &&
              y.firstChild &&
...
` + a.replace(/^\s*\n/, "")
      ...
      er = Z({
        "src/language-html/print/tag.js"(e, n) {
          ...
          function D(q, Y) {
            return (
              !q.isSelfClosing && !q.endSourceSpan && (h(q) || w(q.parent, Y))
            );
          }
          function g(q) {
            return (
      ...
      ig = Z({
        "src/language-html/syntax-vue.js"(e, n) {
          ...
          function a(i) {
            ...
            if (
              !h.some((w, T) => !w && (T === 0 || h.slice(T + 1).some(Boolean)))
            )
              return {
