  ...
  var be = oe((Ce, ae) => {
    var H = Object.getOwnPropertyNames,
      ...
      L = (a, d) =>
        function () {
          return (
            d || (0, a[H(a)[0]])((d = { exports: {} }).exports, d), d.exports
          );
        },
      K = se({ "<define:process>"() {} }),
      ce = L({
...
` + r
      ...
      z = L({
        "node_modules/graphql/polyfills/symbols.js"(a) {
          ...
          K(),
            Object.defineProperty(a, "__esModule", { value: !0 }),
            (a.SYMBOL_TO_STRING_TAG =
              a.SYMBOL_ASYNC_ITERATOR =
              a.SYMBOL_ITERATOR =
                void 0);
          var d =
...
`
            ...
            if (n.length > 120) {
              for (
                var t = Math.floor(s / 80), u = s % 80, y = [], f = 0;
                f < n.length;
                f += 80
              )
...
`);
      ...
      W = L({
        "node_modules/graphql/error/GraphQLError.js"(a) {
          ...
          function D(f, m) {
            return m && (d(m) === "object" || typeof m == "function")
              ? m
              : v(f);
          }
          function v(f) {
          ...
          var u = (function (f) {
            ...
            function o(h, l, T, S, x, b, M) {
              ...
              S && T
                ...
                : R &&
                  (B = R.reduce(function (w, P) {
                    return (
                      P.loc &&
                        w.push((0, r.getLocation)(P.loc.source, P.loc.start)),
                      w
                    );
                  }, []));
              var j = M;
              ...
              return (
                ...
                b != null && b.stack
                  ? (Object.defineProperty(v(C), "stack", {
                      value: b.stack,
                      writable: !0,
                      configurable: !0,
                    }),
...
` + (0, _.printSourceLocation)(f.source, x);
      ...
      Z = L({
        "node_modules/graphql/error/syntaxError.js"(a) {
          ...
          var d = W();
          function i(c, r, _) {
            return new d.GraphQLError("Syntax Error: ".concat(_), void 0, c, [
              r,
            ]);
          }
        },
      ...
      ve = L({
        "node_modules/graphql/jsutils/invariant.js"(a) {
          ...
          function d(i, c) {
            ...
            if (!r)
              throw new Error(
                c != null ? c : "Unexpected invariant triggered."
              );
          }
        },
      }),
      ...
      re = L({
        "node_modules/graphql/jsutils/inspect.js"(a) {
          ...
          function N(v, I) {
            ...
            for (
              var s = Math.min(r, v.length), p = v.length - s, e = [], n = 0;
              n < s;
              ++n
            )
              e.push(k(v[n], I));
            return (
              p === 1
                ? e.push("... 1 more item")
                : p > 1 && e.push("... ".concat(p, " more items")),
              "[" + e.join(", ") + "]"
            );
          }
          function g(v) {
        ...
        "node_modules/graphql/language/blockString.js"(a) {
          ...
          function d(_) {
            var E = _.split(/\r\n|[\n\r]/g),
              k = c(_);
            if (k !== 0)
              for (var O = 1; O < E.length; O++) E[O] = E[O].slice(k);
...
`),
      ...
      Ne = L({
        "node_modules/graphql/language/lexer.js"(a) {
          ...
          function O(t, u) {
            for (
              var y = t.source, f = y.body, m = f.length, o = u.end;
              o < m;
          ...
          function g(t, u, y, f, m, o) {
            ...
            if ((l === 45 && (l = h.charCodeAt(++T)), l === 48)) {
              if (((l = h.charCodeAt(++T)), l >= 48 && l <= 57))
                throw (0, d.syntaxError)(
                  t,
                  T,
                  "Invalid number, unexpected digit after 0: ".concat(k(l), ".")
                );
            ...
            if (
              ...
              throw (0, d.syntaxError)(
                t,
                T,
                "Invalid number, expected digit but got: ".concat(k(l), ".")
              );
            return new i.Token(
              S ? c.TokenKind.FLOAT : c.TokenKind.INT,
              u,
              T,
              f,
              m,
          ...
          function v(t, u, y, f, m) {
            for (
              ...
              if (T === 34)
                return (
                  (S += o.slice(l, h)),
                  new i.Token(c.TokenKind.STRING, u, h + 1, y, f, m, S)
                );
              if (T < 32 && T !== 9)
                throw (0, d.syntaxError)(
                  t,
                  h,
                  "Invalid character within String: ".concat(k(T), ".")
                );
              if ((++h, T === 92)) {
...
`;
          ...
          function I(t, u, y, f, m, o) {
            for (
              var h = t.body, l = u + 3, T = l, S = 0, x = "";
              l < h.length && !isNaN((S = h.charCodeAt(l)));
            ...
            return (
              ...
              (s.parseValueLiteral = function (e) {
                ...
                switch (n.kind) {
                  ...
                  case r.TokenKind.INT:
                    return (
                      this._lexer.advance(),
                      { kind: i.Kind.INT, value: n.value, loc: this.loc(n) }
                    );
                  case r.TokenKind.FLOAT:
                    return (
                      this._lexer.advance(),
                      { kind: i.Kind.FLOAT, value: n.value, loc: this.loc(n) }
                    );
              ...
              (s.parseList = function (e) {
                ...
                return {
                  kind: i.Kind.LIST,
                  values: this.any(
                    r.TokenKind.BRACKET_L,
                    u,
                    r.TokenKind.BRACKET_R
                  ),
                  loc: this.loc(t),
                };
              }),
              ...
              (s.unexpected = function (e) {
                ...
                return (0, d.syntaxError)(
                  this._lexer.source,
                  n.start,
                  "Unexpected ".concat(D(n), ".")
                );
              }),
    ...
    function Ke(a) {
      ...
      for (; c.kind !== "<EOF>"; )
        c.kind === "Comment" &&
          (Object.assign(c, { column: c.column - 1 }), d.push(c)),
          (c = c.next);
      return d;
    }
    function ie(a) {
