...
var ii = k((jh, ri) => {
  var un = $(),
    ...
    _t = un.Object,
    pn = hn("".split);
  ri.exports = ln(function () {
    return !_t("z").propertyIsEnumerable(0);
  })
    ? function (n) {
        return cn(n) == "String" ? pn(n, "") : _t(n);
      }
    : _t;
});
var St = k((qh, si) => {
  ...
  si.exports = function (n) {
    if (n == null) throw dn("Can't call method on " + n);
    return n;
  };
});
var tt = k((Mh, ai) => {
...
var Ie = k((zh, oi) => {
  ...
  oi.exports = function (n) {
    return typeof n == "object" ? n !== null : gn(n);
  };
});
var rt = k((Wh, ui) => {
  var wt = $(),
  ...
  ui.exports = function (n, o) {
    return arguments.length < 2 ? yn(wt[n]) : wt[n] && wt[n][o];
  };
});
var li = k((Gh, hi) => {
  var An = ce();
  hi.exports = An({}.isPrototypeOf);
});
var pi = k((Kh, ci) => {
  var Cn = rt();
  ci.exports = Cn("navigator", "userAgent") || "";
});
var yi = k((Xh, xi) => {
  var gi = $(),
    kt = pi(),
  ...
  vi &&
    ((he = vi.split(".")),
    (it = he[0] > 0 && he[0] < 4 ? 1 : +(he[0] + he[1])));
  !it &&
    kt &&
    ((he = kt.match(/Edge\/(\d+)/)),
    (!he || he[1] >= 74) &&
      ((he = kt.match(/Chrome\/(\d+)/)), he && (it = +he[1])));
  xi.exports = it;
});
var Ft = k((Hh, Ci) => {
  var Ai = yi(),
  ...
  Ci.exports =
    ...
    !En(function () {
      ...
      return (
        ...
        (!Symbol.sham && Ai && Ai < 41)
      );
    });
});
var Bt = k((Jh, Ei) => {
  var bn = Ft();
  Ei.exports = bn && !Symbol.sham && typeof Symbol.iterator == "symbol";
});
var Tt = k((Yh, bi) => {
  var _n = $(),
    Sn = rt(),
  ...
  bi.exports = Fn
    ...
    : function (n) {
        var o = Sn("Symbol");
        return wn(o) && kn(o.prototype, Bn(n));
      };
});
var Si = k((Qh, _i) => {
  var Tn = $(),
...
var ki = k((Zh, wi) => {
  ...
  wi.exports = function (n) {
    if (Nn(n)) return n;
    throw On(Dn(n) + " is not a function");
  };
});
var Bi = k(($h, Fi) => {
  var Ln = ki();
...
var st = k((rl, Oi) => {
  ...
  Oi.exports = function (n, o) {
    try {
      jn(Di, n, { value: o, configurable: !0, writable: !0 });
    } catch {
      Di[n] = o;
    }
    return o;
...
var Ot = k((ol, zi) => {
  ...
  zi.exports = function (n) {
    return "Symbol(" + (n === void 0 ? "" : n) + ")_" + $n(++Qn + Zn, 36);
  };
});
var Ji = k((ul, Hi) => {
  var eo = $(),
    ...
    Se = eo.Symbol,
    Ki = Se && Se.for,
    io = Xi ? Se : (Se && Se.withoutSetter) || ro;
...
var $i = k((hl, Zi) => {
  ...
  Zi.exports = function (n, o) {
    ...
    var u = no(n, lo),
      l;
    if (u) {
      if ((o === void 0 && (o = "default"), (l = ao(u, n, o)), !Yi(l) || Qi(l)))
        return l;
      throw ho("Can't convert object to primitive value");
    }
    return o === void 0 && (o = "number"), oo(n, o);
  };
});
var Lt = k((ll, es) => {
  var co = $i(),
...
var is = k((cl, rs) => {
  var fo = $(),
    ts = Ie(),
    Vt = fo.document,
    mo = ts(Vt) && ts(Vt.createElement);
  rs.exports = function (n) {
    return mo ? Vt.createElement(n) : {};
  };
});
var Rt = k((pl, ss) => {
  var vo = _e(),
  ...
  ss.exports =
    ...
    !go(function () {
      return (
        Object.defineProperty(xo("div"), "a", {
          get: function () {
            return 7;
          },
        }).a != 7
...
var jt = k((ns) => {
  ...
  ns.f = yo
    ...
    : function (o, u) {
        ...
        if (So(o, u)) return Eo(!Ao(Co.f, o, u), o[u]);
      };
});
var us = k((dl, os) => {
  var ko = _e(),
...
var qt = k((ml, ls) => {
  ...
  ls.exports = function (n) {
    if (Bo(n)) return n;
    throw Io(To(n) + " is not an object");
  };
});
var Gt = k((ps) => {
  var Po = $(),
  ...
  ps.f = No
    ? Oo
      ? function (o, u, l) {
          if (
            ...
            m &&
              ...
              ((o[u] = l.value),
              (l = {
                configurable: zt in l ? l[zt] : m[zt],
                enumerable: Ut in l ? l[Ut] : m[Ut],
                writable: !1,
              }));
          }
          return Mt(o, u, l);
      ...
      : Mt
    : function (o, u, l) {
        if ((nt(o), (u = cs(u)), nt(l), Do))
          try {
            return Mt(o, u, l);
          } catch {}
        if ("get" in l || "set" in l) throw Lo("Accessors not supported");
...
var gs = k((yl, vs) => {
  var Wo = $(),
    ...
    Ko = Xt(),
    ms = Wo.WeakMap;
  vs.exports = Go(ms) && /native code/.test(Ko(ms));
});
var As = k((Al, ys) => {
  var Xo = Dt(),
    Ho = Ot(),
...
var ks = k((El, ws) => {
  var Jo = gs(),
    ...
    ru = function (n) {
      return function (o) {
        var u;
        if (!Yo(o) || (u = qe(o)).type !== n)
          throw $t("Incompatible receiver, " + n + " required");
        return u;
      };
    };
  Jo || Qt.state
    ? ((Ce = Qt.state || (Qt.state = new eu())),
      (bs = Jt(Ce.get)),
      (Zt = Jt(Ce.has)),
      (_s = Jt(Ce.set)),
      (ut = function (n, o) {
  ...
  var Ce, bs, Zt, _s, we;
  ws.exports = { set: ut, get: qe, has: ht, enforce: tu, getterFor: ru };
});
var Ts = k((bl, Bs) => {
  var er = _e(),
    iu = Ae(),
    Fs = Function.prototype,
    su = er && Object.getOwnPropertyDescriptor,
    tr = iu(Fs, "name"),
    au = tr && function () {}.name === "something",
    nu = tr && (!er || (er && su(Fs, "name").configurable));
  Bs.exports = { EXISTS: tr, PROPER: au, CONFIGURABLE: nu };
});
var Os = k((_l, Ds) => {
  var ou = $(),
    Is = pe(),
    ...
    pu = Ns.get,
    fu = Ns.enforce,
    du = String(String).split("String");
  (Ds.exports = function (n, o, u, l) {
    var m = l ? !!l.unsafe : !1,
      E = l ? !!l.enumerable : !1,
      y = l ? !!l.noTargetGet : !1,
      A = l && l.name !== void 0 ? l.name : o,
      b;
    if (
      (Is(u) &&
        (String(A).slice(0, 7) === "Symbol(" &&
          (A = "[" + String(A).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
        (!uu(u, "name") || (cu && u.name !== A)) && Ps(u, "name", A),
        (b = fu(u)),
        b.source || (b.source = du.join(typeof A == "string" ? A : ""))),
      n === ou)
    ) {
      E ? (n[o] = u) : hu(o, u);
      return;
    } else m ? !y && n[o] && (E = !0) : delete n[o];
    E ? (n[o] = u) : Ps(n, o, u);
  })(Function.prototype, "toString", function () {
    return (Is(this) && pu(this).source) || lu(this);
  });
});
var rr = k((Sl, Ls) => {
  var mu = Math.ceil,
...
var qs = k((kl, js) => {
  ...
  js.exports = function (n) {
    return n > 0 ? Cu(Au(n), 9007199254740991) : 0;
  };
});
var Us = k((Fl, Ms) => {
  var Eu = qs();
    ...
    zs = function (n) {
      return function (o, u, l) {
        var m = bu(o),
          ...
          A;
        if (n && u != u) {
          for (; E > y; ) if (((A = m[y++]), A != A)) return !0;
        } else
          for (; E > y; y++)
            if ((n || y in m) && m[y] === u) return n || y || 0;
        return !n && -1;
      };
    };
...
var Hs = k((Tl, Xs) => {
  ...
  Xs.exports = function (n, o) {
    var u = ku(n),
      ...
      m = [],
      E;
    for (E in u) !ir(Bu, E) && ir(u, E) && Ks(m, E);
    for (; o.length > l; ) ir(u, (E = o[l++])) && (~Fu(m, E) || Ks(m, E));
    return m;
  };
});
var Ys = k((Il, Js) => {
...
var aa = k((Ol, sa) => {
  ...
  sa.exports = function (n, o, u) {
    for (var l = ju(o), m = Mu.f, E = qu.f, y = 0; y < l.length; y++) {
      var A = l[y];
      !ia(n, A) && !(u && ia(u, A)) && m(n, A, E(o, A));
    }
  };
});
var oa = k((Ll, na) => {
  var Uu = ye(),
    ...
    Me = function (n, o) {
      var u = Ku[Gu(n)];
      return u == Hu ? !0 : u == Xu ? !1 : zu(o) ? Uu(o) : !!o;
    },
    Gu = (Me.normalize = function (n) {
      return String(n).replace(Wu, ".").toLowerCase();
    }),
    Ku = (Me.data = {}),
    Xu = (Me.NATIVE = "N"),
    Hu = (Me.POLYFILL = "P");
  ...
  ua.exports = function (n, o) {
    ...
    if (
      ...
      for (A in o) {
        if (
          ((g = o[A]),
          n.noTargetGet ? ((V = Ju(y, A)), (b = V && V.value)) : (b = y[A]),
          (E = eh(l ? A : u + (m ? "." : "#") + A, n.forced)),
          !E && b !== void 0)
        ) {
          if (typeof g == typeof b) continue;
          $u(g, b);
        }
        (n.sham || (b && b.sham)) && Yu(g, "sham", !0), Qu(y, A, g, n);
      }
  };
});
var la = k(() => {
...
var ur = Object.defineProperty,
    ...
    if ((o && typeof o == "object") || typeof o == "function")
      for (let m of hr(o))
        !sh.call(n, m) &&
          ...
          ur(n, m, {
            get: () => o[m],
            enumerable: !(l = ih(o, m)) || l.enumerable,
          });
    return n;
  },
  oh = (n) => nh(ur({}, "__esModule", { value: !0 }), n),
  J = ca({ "<define:process>"() {} }),
  lr = Y({
  ...
  pa = Y({
    "src/utils/try-combinations.js"(n, o) {
      ...
      function u() {
        let l;
        for (var m = arguments.length, E = new Array(m), y = 0; y < m; y++)
          E[y] = arguments[y];
        for (let [A, b] of E.entries())
          try {
            return { result: b() };
          } catch (g) {
            A === 0 && (l = g);
...
`);
  ...
  fh = Y({
    "node_modules/jest-docblock/build/index.js"(n) {
      ...
      function v(C) {
        let H = C.match(y);
        return H && H[0] ? C.substring(H[0].length) : C;
      }
      function q(C) {
        return B(C).pragmas;
      }
      function B(C) {
        let H = (0, u().default)(C) || o().EOL;
        C = C.replace(E, "").replace(m, "").replace(R, "$1");
        let L = "";
        for (; L !== C; )
          (L = C), (C = C.replace(g, "".concat(H, "$1 $2").concat(H)));
        C = C.replace(b, "").trimRight();
        let i = Object.create(null),
          _ = C.replace(V, "").replace(b, "").trimRight(),
          P;
        for (; (P = V.exec(C)); ) {
          let M = P[2].replace(A, "");
          typeof i[P[1]] == "string" || Array.isArray(i[P[1]])
            ? (i[P[1]] = N.concat(i[P[1]], M))
            : (i[P[1]] = M);
        }
        return { comments: _, pragmas: i };
      }
      function I(C) {
        let { comments: H = "", pragmas: L = {} } = C,
        ...
        if (!H) {
          ...
          if (ee.length === 1 && !Array.isArray(L[ee[0]])) {
            let ie = L[ee[0]];
            return "".concat(_, " ").concat(w(ee[0], ie)[0]).concat(M);
          }
        }
        let te =
          H.split(i)
            .map((ie) => "".concat(P, " ").concat(ie))
            .join(i) + i;
        return _ + i + (H ? te : "") + (H && ee.length ? P + i : "") + ae + M;
      }
      function w(C, H) {
        return N.concat(H).map((L) => "@".concat(C, " ").concat(L).trim());
      }
    },
  }),
  dh = Y({
...
`);
  ...
  vh = Y({
    "src/language-js/pragma.js"(n, o) {
      "use strict";
      J();
      var { parseWithComments: u, strip: l, extract: m, print: E } = fh(),
        { normalizeEndOfLine: y } = dh(),
        A = mh();
      function b(R) {
        let N = A(R);
        N && (R = R.slice(N.length + 1));
        let T = m(R),
          { pragmas: v, comments: q } = u(T);
        return { shebang: N, text: R, pragmas: v, comments: q };
      }
      function g(R) {
        let N = Object.keys(b(R).pragmas);
        return N.includes("prettier") || N.includes("format");
      }
      function V(R) {
        let { shebang: N, text: T, pragmas: v, comments: q } = b(R),
          B = l(T),
          I = E({
            pragmas: Object.assign({ format: "" }, v),
            comments: q.trimStart(),
          });
        return (
          (N
            ? "".concat(
...
`) +
      ...
      o.exports = { hasPragma: g, insertPragma: V };
    },
  }),
  gh = Y({
  ...
  wa = Y({
    "src/language-js/loc.js"(n, o) {
      ...
      var u = gh();
      function l(b, g) {
        let { ignoreDecorators: V } = g || {};
        if (!V) {
          let R = (b.declaration && b.declaration.decorators) || b.decorators;
          if (u(R)) return l(R[0]);
        }
        return b.range ? b.range[0] : b.start;
      }
      function m(b) {
        return b.range ? b.range[1] : b.end;
      }
      function E(b, g) {
        let V = l(b);
        return Number.isInteger(V) && V === l(g);
      }
      function y(b, g) {
        let V = m(b);
        return Number.isInteger(V) && V === m(g);
      }
      function A(b, g) {
        return E(b, g) && y(b, g);
      }
      o.exports = { locStart: l, locEnd: m, hasSameLocStart: E, hasSameLoc: A };
    },
  }),
  ka = Y({
    "src/language-js/parse/utils/create-parser.js"(n, o) {
      ...
      J();
      var { hasPragma: u } = vh(),
        { locStart: l, locEnd: m } = wa();
      function E(y) {
        return (
          (y = typeof y == "function" ? { parse: y } : y),
          Object.assign(
            { astFormat: "estree", hasPragma: u, locStart: l, locEnd: m },
            y
          )
        );
      }
  ...
  yh = Y({
    "src/language-js/utils/is-block-comment.js"(n, o) {
      "use strict";
      J();
      var u = new Set(["Block", "CommentBlock", "MultiLine"]),
        l = (m) => u.has(m == null ? void 0 : m.type);
      o.exports = l;
    },
  }),
  Ah = Y({
    "src/language-js/utils/is-type-cast-comment.js"(n, o) {
      ...
      var u = yh();
      function l(m) {
        return u(m) && m.value[0] === "*" && /@type\b/.test(m.value);
      }
      o.exports = l;
    },
  }),
  ...
  Fa = Y({
    "src/language-js/parse/postprocess/visit-node.js"(n, o) {
      ...
      function u(l, m) {
        if (Array.isArray(l)) {
          for (let E = 0; E < l.length; E++) l[E] = u(l[E], m);
          return l;
        }
        if (l && typeof l == "object" && typeof l.type == "string") {
          let E = Object.keys(l);
          for (let y = 0; y < E.length; y++) l[E[y]] = u(l[E[y]], m);
          return m(l) || l;
        }
        return l;
      }
  ...
  Ba = Y({
    "src/language-js/parse/postprocess/throw-syntax-error.js"(n, o) {
      "use strict";
      J();
      var u = lr();
      function l(m, E) {
        let { start: y, end: A } = m.loc;
        throw u(E, {
    ...
    "src/language-js/parse/postprocess/typescript.js"(n, o) {
      ...
      function m(A, b, g) {
        ...
        (!Array.isArray(R) ||
          ...
          l(b, "Leading decorators must be attached to a class declaration");
      }
      function E(A, b) {
        A.kind !== 167 ||
          (A.modifiers && !A.modifiers.some((R) => R.kind === 126)) ||
          (A.initializer &&
            b.value === null &&
            l(b, "Abstract property cannot have an initializer"));
      }
      function y(A, b) {
        let { esTreeNodeToTSNodeMap: g, tsNodeToESTreeNodeMap: V } =
          b.tsParseResult;
        u(A, (R) => {
          let N = g.get(R);
          if (!N) return;
      ...
      o.exports = { throwErrorForInvalidNodes: y };
    },
  }),
  Ta = Y({
    "src/language-js/parse/postprocess/index.js"(n, o) {
      ...
      var { locStart: u, locEnd: l } = wa(),
        ...
        y = Ch(),
        A = Fa(),
        { throwErrorForInvalidNodes: b } = Eh(),
        g = Ba();
      function V(v, q) {
        if (
          (q.parser === "typescript" &&
            /@|abstract/.test(q.originalText) &&
            b(v, q),
          q.parser !== "typescript" &&
            q.parser !== "flow" &&
            q.parser !== "acorn" &&
          ...
          let I = new Set();
          (v = A(v, (w) => {
            w.leadingComments && w.leadingComments.some(E) && I.add(u(w));
          })),
            (v = A(v, (w) => {
              if (w.type === "ParenthesizedExpression") {
                let { expression: C } = w;
                if (C.type === "TypeCastExpression")
                  return (C.range = w.range), C;
                let H = u(w);
                if (!I.has(H))
                  return (
          ...
          (v = A(v, (I) => {
            switch (I.type) {
              ...
              case "TSParenthesizedType":
                return (
                  m(I.typeAnnotation) ||
                    ...
                    (I.typeAnnotation.range = [u(I), l(I)]),
                  I.typeAnnotation
                );
              case "TSTypeParameter":
                if (typeof I.name == "string") {
                  ...
                  I.name = {
                    type: "Identifier",
                    name: I.name,
                    range: [w, w + I.name.length],
                  };
                }
                break;
              case "ObjectExpression":
                if (q.parser === "typescript") {
                  let w = I.properties.find(
                    (C) =>
                      C.type === "Property" &&
                      C.value.type === "TSEmptyBodyFunctionExpression"
                  );
                  w && g(w.value, "Unexpected token.");
                }
                break;
              case "SequenceExpression": {
                let w = y(I.expressions);
                I.range = [u(I), Math.min(l(w), l(I))];
                break;
              }
              case "TopicReference":
              ...
              case "ExportAllDeclaration": {
                let { exported: w } = I;
                if (q.parser === "meriyah" && w && w.type === "Identifier") {
                  let C = q.originalText.slice(u(w), l(w));
                  (C.startsWith('"') || C.startsWith("'")) &&
                    (I.exported = Object.assign(
                      Object.assign({}, I.exported),
                      {},
                      { type: "Literal", value: I.exported.name, raw: C }
                    ));
                }
                break;
              }
        ...
        function B(I, w) {
          q.originalText[l(w)] !== ";" && (I.range = [u(I), l(w)]);
        }
      }
      function R(v) {
        switch (v.type) {
          case "CallExpression":
            (v.type = "OptionalCallExpression"), (v.callee = R(v.callee));
            break;
          case "MemberExpression":
            (v.type = "OptionalMemberExpression"), (v.object = R(v.object));
            break;
          case "TSNonNullExpression":
            v.expression = R(v.expression);
            break;
        }
        return v;
      }
      function N(v) {
        return (
          ...
          v.right.type === "LogicalExpression" &&
          v.operator === v.right.operator
        );
      }
      function T(v) {
        return N(v)
    ...
    "node_modules/acorn/dist/acorn.js"(n, o) {
      J(),
        (function (u, l) {
          ...
          function L(e, t) {
            return (
              t === void 0 && (t = {}), (t.keyword = e), (H[e] = new B(e, t))
            );
          }
          var i = {
              num: new B("num", C),
              ...
              _default: L("default", w),
              _do: L("do", { isLoop: !0, beforeExpr: !0 }),
              _else: L("else", w),
              _finally: L("finally"),
              _for: L("for", { isLoop: !0 }),
              _function: L("function", C),
              _if: L("if"),
              _return: L("return", w),
              _switch: L("switch"),
              _throw: L("throw", w),
          ...
          function pt(e) {
            var t = {};
            for (var r in me) t[r] = e && D(e, r) ? e[r] : me[r];
            if (
...
Defaulting to 2020, but this will stop working in the future.`)),
          ...
          function ft(e, t) {
            return function (r, s, a, h, c, d) {
              ...
              e.locations && (x.loc = new X(this, c, d)),
                e.ranges && (x.range = [a, h]),
                t.push(x);
            };
          }
          var Ee = 1,
...
`,
          ...
          (Z.prototype.parse = function () {
            ...
            (le.inGenerator.get = function () {
              return (
                (this.currentVarScope().flags & Ue) > 0 &&
                !this.currentVarScope().inClassFieldInit
              );
            }),
            (le.inAsync.get = function () {
              return (
                (this.currentVarScope().flags & De) > 0 &&
                !this.currentVarScope().inClassFieldInit
              );
            }),
          ...
          (j.isLet = function (e) {
            ...
            if (s === 123) return !0;
            if (v(s, !0)) {
              for (var a = r + 1; q((s = this.input.charCodeAt(a)), !0); ) ++a;
              if (s === 92 || (s > 55295 && s < 56320)) return !0;
              var h = this.input.slice(r, a);
              if (!y.test(h)) return !0;
            }
            return !1;
          }),
              ...
              switch ((this.isLet(e) && ((s = i._var), (h = "let")), s)) {
                ...
                case i._import:
                  if (this.options.ecmaVersion > 10 && s === i._import) {
                    ...
                    var c = te.exec(this.input),
                      d = this.pos + c[0].length,
                      x = this.input.charCodeAt(d);
                    if (x === 40 || x === 46)
                ...
                default:
                  ...
                  return s === i.name &&
                    W.type === "Identifier" &&
                    this.eat(i.colon)
                    ? this.parseLabeledStatement(a, U, W, e)
                    : this.parseExpressionStatement(a, W);
              }
            }),
            ...
            (j.parseForStatement = function (e) {
              ...
              var h = this.isContextual("let"),
                c = !1,
                d = new We(),
                x = this.parseExpression(t > -1 ? "await" : !0, d);
              return this.type === i._in ||
                ...
                ? (this.options.ecmaVersion >= 9 &&
                  ...
                  this.toAssignable(x, !1, d),
                  this.checkLValPattern(x),
                  this.parseForIn(e, x))
            ...
            (j.parseFunctionStatement = function (e, t, r) {
              return (
                this.next(), this.parseFunction(e, Le | (r ? 0 : yt), !1, t)
              );
            }),
          ...
          (j.parseTryStatement = function (e) {
            ...
            (j.parseLabeledStatement = function (e, t, r, s) {
            ...
            (j.parseVarId = function (e, t) {
              (e.id = this.parseBindingAtom()),
                this.checkLValPattern(e.id, t === "var" ? gt : fe, !1);
            });
          var Le = 1,
            yt = 2,
            gr = 4;
          (j.parseFunction = function (e, t, r, s, a) {
            this.initFunction(e),
              (this.options.ecmaVersion >= 9 ||
                (this.options.ecmaVersion >= 6 && !s)) &&
                (this.type === i.star && t & yt && this.unexpected(),
                (e.generator = this.eat(i.star))),
              this.options.ecmaVersion >= 8 && (e.async = !!s),
              t & Le &&
                ((e.id =
                  t & gr && this.type !== i.name ? null : this.parseIdent()),
                e.id &&
                  !(t & yt) &&
            ...
            return (
              ...
              this.finishNode(
                e,
                t & Le ? "FunctionDeclaration" : "FunctionExpression"
              )
            );
          }),
            ...
            (j.parseClassElement = function (e) {
              ...
              if (
                ...
                (this.eatContextual("get") || this.eatContextual("set")) &&
                  (this.isClassElementNameStart() ? (c = x) : (s = x));
              }
              if (
                (s
                  ? ((r.computed = !1),
                ...
                var U = !r.static && Ge(r, "constructor"),
                  W = U && e;
                U &&
                  c !== "method" &&
                  this.raise(
                  ...
                  (r.kind = U ? "constructor" : c),
                  this.parseClassMethod(r, a, h, W);
            ...
            (j.parseClassMethod = function (e, t, r, s) {
              var a = e.key;
              e.kind === "constructor"
            ...
            (j.parseClassStaticBlock = function (e) {
              ...
              var t = this.labels;
              for (
                this.labels = [], this.enterScope(Oe | dt);
                this.type !== i.braceR;
          ...
          (j.parseExport = function (e, t) {
            ...
            if (this.eat(i._default)) {
              ...
              if (this.type === i._function || (r = this.isAsyncFunction())) {
                ...
                this.next(),
                  r && this.next(),
                  (e.declaration = this.parseFunction(s, Le | gr, !1, r));
              ...
              for (this.expect(i.braceL); !this.eat(i.braceR); ) {
                ...
                (s.local = this.parseModuleExportName()),
                  ...
                  this.checkExport(
                    e,
                    s.exported[
                      s.exported.type === "Identifier" ? "name" : "value"
                    ],
                    s.exported.start
                  ),
            ...
            (j.parseImport = function (e) {
              return (
                this.next(),
                this.type === i.string
                  ? ((e.specifiers = Da), (e.source = this.parseExprAtom()))
          ...
          (z.checkPropClash = function (e, t, r) {
            if (
              ...
              if (c) {
                var d;
                h === "init"
                  ? (d = (this.strict && c.init) || c.get || c.set)
                  : (d = c.init || c[h]),
                  d &&
            ...
            (z.parseMaybeAssign = function (e, t, r) {
              ...
              if ((r && (U = r.call(this, U, d, x)), this.type.isAssign)) {
                var W = this.startNodeAt(d, x);
                return (
                  (W.operator = this.value),
                  this.type === i.eq && (U = this.toAssignable(U, !1, t)),
                  s ||
            ...
            (z.parseExprOp = function (e, t, r, s, a) {
              ...
              if (h != null && (!a || this.type !== i._in) && h > s) {
                ...
                var U = this.start,
                  ...
                  be = this.buildBinary(t, r, e, re, x, c || d);
                return (
            ...
            (z.buildBinary = function (e, t, r, s, a, h) {
            ...
            (z.parseMaybeUnary = function (e, t, r, s) {
              var a = this.start,
                h = this.startLoc,
                c;
              if (this.isContextual("await") && this.canAwait)
                ...
                var d = this.startNode(),
                  x = this.type === i.incDec;
                (d.operator = this.value),
                  (d.prefix = !0),
                  this.next(),
                  (d.argument = this.parseMaybeUnary(null, !0, x, s)),
                  ...
                  x
                    ...
                    : d.operator === "delete" && xr(d.argument)
                    ? this.raiseRecoverable(
                        d.start,
                  ...
                  (c = this.finishNode(
                    d,
                    x ? "UpdateExpression" : "UnaryExpression"
                  ));
                ...
                for (; this.type.postfix && !this.canInsertSemicolon(); ) {
                  var U = this.startNodeAt(a, h);
                  (U.operator = this.value),
                    (U.prefix = !1),
                    (U.argument = c),
                    this.checkLValSimple(c),
                    this.next(),
                    (c = this.finishNode(U, "UpdateExpression"));
                }
              }
          ...
          (z.parseExprSubscripts = function (e, t) {
            ...
            (z.parseSubscripts = function (e, t, r, s, a) {
              for (
                var h =
                    this.options.ecmaVersion >= 8 &&
                    e.type === "Identifier" &&
                ...
                var d = this.parseSubscript(e, t, r, s, h, c, a);
                if (
                  (d.optional && (c = !0),
                  d === e || d.type === "ArrowFunctionExpression")
                ) {
                  if (c) {
                    var x = this.startNodeAt(t, r);
                    (x.expression = d),
                      (d = this.finishNode(x, "ChainExpression"));
                  }
                  return d;
                }
                e = d;
            ...
            (z.parseSubscript = function (e, t, r, s, a, h, c) {
              var d = this.options.ecmaVersion >= 11,
                x = d && this.eat(i.questionDot);
              s &&
                x &&
                this.raise(
                  this.lastTokStart,
              ...
              var U = this.eat(i.bracketL);
              if (
                U ||
                (x && this.type !== i.parenL && this.type !== i.backQuote) ||
                this.eat(i.dot)
              ) {
                ...
                (this.yieldPos = 0),
                  (this.awaitPos = 0),
                  (this.awaitIdentPos = 0);
                var Qe = this.parseExprList(
                  i.parenR,
                  this.options.ecmaVersion >= 8,
                  !1,
                  re
                );
                if (a && !x && !this.canInsertSemicolon() && this.eat(i.arrow))
                  return (
            ...
            (z.parseExprAtom = function (e, t) {
              ...
              switch (this.type) {
                ...
                case i.regexp:
                  var x = this.value;
                  return (
                    (r = this.parseLiteral(x.value)),
                    (r.regex = { pattern: x.pattern, flags: x.flags }),
                    r
                  );
                case i.num:
                case i.string:
              ...
              if (this.options.ecmaVersion >= 6) {
                ...
                for (
                  ...
                  if (
                    ...
                    x.push(this.parseMaybeAssign(!1, re, this.parseParenItem));
                ...
                if (
                  ...
                  return (
                    ...
                    (this.yieldPos = be),
                    (this.awaitPos = je),
                    this.parseParenArrowList(r, s, x, t)
                  );
                (!x.length || W) && this.unexpected(this.lastTokStart),
                  Fe && this.unexpected(Fe),
                  this.checkExpressionErrors(re, !0),
                  (this.yieldPos = be || this.yieldPos),
                  (this.awaitPos = je || this.awaitPos),
                  x.length > 1
                    ? ((a = this.startNodeAt(c, d)),
                      (a.expressions = x),
            ...
            (z.parseParenArrowList = function (e, t, r, s) {
              return this.parseArrowExpression(
...
`
            ...
            (z.parseProperty = function (e, t) {
              ...
              return (
                ...
                this.isAsyncProp(r)
                  ...
                  : (a = !1),
                this.parsePropertyValue(r, e, s, a, h, c, t, d),
                this.finishNode(r, "Property")
              );
            }),
            (z.parsePropertyValue = function (e, t, r, s, a, h, c, d) {
              if (
            ...
            (z.parseArrowExpression = function (e, t, r, s) {
              var a = this.yieldPos,
                h = this.awaitPos,
                c = this.awaitIdentPos;
              return (
            ...
            (z.parseFunctionBody = function (e, t, r, s) {
            ...
            (z.checkParams = function (e, t) {
              for (
                var r = Object.create(null), s = 0, a = e.params;
                s < a.length;
                s += 1
              ) {
                var h = a[s];
            ...
            (z.parseExprList = function (e, t, r, s) {
            ...
            (xe.declareName = function (e, t, r) {
              ...
              if (t === fe) {
                ...
                for (var d = this.scopeStack.length - 1; d >= 0; --d) {
                  var x = this.scopeStack[d];
                  if (
                    (x.lexical.indexOf(e) > -1 &&
                      !(x.flags & pr && x.lexical[0] === e)) ||
                    (!this.treatFunctionsAsVarInScope(x) &&
                      x.functions.indexOf(e) > -1)
                  ) {
                    s = !0;
                    break;
                  }
          ...
          var Ar =
            ...
            Ra = br,
            ja = { 9: Ar, 10: Cr, 11: Er, 12: br, 13: Ra },
            _r =
            ...
            Ma = { 9: Sr, 10: wr, 11: kr, 12: Fr, 13: qa },
            Br = {};
          function Ua(e) {
            var t = (Br[e] = {
              binary: f(ja[e] + " " + _r),
              nonBinary: { General_Category: f(_r), Script: f(Ma[e]) },
            });
            ...
            de = function (t) {
              (this.parser = t),
                ...
                (this.unicodeProperties =
                  Br[t.options.ecmaVersion >= 13 ? 13 : t.options.ecmaVersion]),
                (this.source = ""),
                (this.flags = ""),
                (this.start = 0),
                (this.switchU = !1),
          ...
          (O.regexp_eatPatternCharacters = function (e) {
            for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Ir(r); )
              e.advance();
            return e.pos !== t;
          }),
          ...
          (O.regexp_eatIdentityEscape = function (e) {
            ...
            (O.regexp_eatCharacterClassEscape = function (e) {
              var t = e.current();
              if (Xa(t)) return (e.lastIntValue = -1), e.advance(), !0;
              if (
                e.switchU &&
                this.options.ecmaVersion >= 9 &&
                (t === 80 || t === 112)
          ...
          (O.regexp_eatUnicodePropertyValueExpression = function (e) {
            ...
            (O.regexp_validateUnicodePropertyNameAndValue = function (e, t, r) {
          ...
          O.regexp_eatUnicodePropertyValue = function (e) {
            var t = 0;
            for (e.lastStringValue = ""; Ha((t = e.current())); )
              (e.lastStringValue += Xe(t)), e.advance();
            return e.lastStringValue !== "";
          };
          function Ha(e) {
          ...
          (O.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
            ...
            (O.regexp_eatClassAtom = function (e) {
              ...
              if (e.eat(92)) {
                ...
                if (e.switchU) {
                  var r = e.current();
                  (r === 99 || Lr(r)) && e.raise("Invalid class escape"),
                    e.raise("Invalid escape");
                }
                e.pos = t;
              }
          ...
          var Je = function (t) {
              (this.type = t.type),
                ...
                (this.end = t.end),
                t.options.locations &&
                  (this.loc = new X(t, t.startLoc, t.endLoc)),
              ...
              e: for (; this.pos < this.input.length; ) {
                ...
                switch (e) {
                  ...
                  default:
                    if (
                      (e > 8 && e < 14) ||
                      (e >= 5760 && ae.test(String.fromCharCode(e)))
                    )
                      ++this.pos;
                    else break e;
                }
          ...
          (G.readRadixNumber = function (e) {
            ...
            (G.readNumber = function (e) {
              ...
              r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
                ...
                v(this.fullCharCodeAtPos()) &&
                  this.raise(this.pos, "Identifier directly after number");
              var h = Ja(this.input.slice(t, this.pos), r);
...
`;
            ...
            (G.readWord = function () {
              var e = this.readWord1(),
                t = i.name;
              return (
                this.keywords.test(e) && (t = H[e]), this.finishToken(t, e)
              );
            });
          var jr = "8.7.0";
          Z.acorn = {
          ...
          (u.Node = Ve),
            ...
            (u.defaultOptions = me),
            (u.getLineInfo = oe),
            (u.isIdentifierChar = q),
            (u.isIdentifierStart = v),
            (u.isNewLine = M),
            (u.keywordTypes = H),
            (u.lineBreak = _),
            (u.lineBreakG = P),
  ...
  Ia = Y({
    "node_modules/acorn-jsx/index.js"(n, o) {
      ...
      function y(g) {
        ...
        if (!V) {
          let R = g.tokTypes,
            ...
            q = new N("</tag", !1),
            B = new N("<tag>...</tag>", !0, !0),
            I = { tc_oTag: v, tc_cTag: q, tc_expr: B },
            w = {
          ...
          (w.jsxTagStart.updateContext = function () {
            this.context.push(B), this.context.push(v), (this.exprAllowed = !1);
          }),
            (w.jsxTagEnd.updateContext = function (C) {
              let H = this.context.pop();
              (H === v && C === R.slash) || H === q
                ? (this.context.pop(),
                  (this.exprAllowed = this.curContext() === B))
                : (this.exprAllowed = !0);
            }),
            (V = { tokContexts: I, tokTypes: w }),
            E.set(g, V);
        }
        return V;
      }
      function A(g) {
        ...
        if (g.type === "JSXNamespacedName")
          return g.namespace.name + ":" + g.name.name;
        if (g.type === "JSXMemberExpression")
          return A(g.object) + "." + A(g.property);
      }
      ...
      function b(g, V) {
        let R = V.acorn || ct(),
          ...
          v = N.tokTypes,
          q = R.tokContexts,
          B = N.tokContexts.tc_oTag,
          I = N.tokContexts.tc_cTag,
          w = N.tokContexts.tc_expr,
          C = R.isNewLine,
          H = R.isIdentifierStart,
          L = R.isIdentifierChar;
          ...
          jsx_readToken() {
            ...
            for (;;) {
              ...
              switch (P) {
                ...
                case 123:
                  return this.pos === this.start
                    ? P === 60 && this.exprAllowed
                      ? (++this.pos, this.finishToken(v.jsxTagStart))
                      : this.getTokenFromCode(P)
                    : ((i += this.input.slice(_, this.pos)),
                      this.finishToken(v.jsxText, i));
                case 38:
                  (i += this.input.slice(_, this.pos)),
...
`))
          ...
          jsx_readEntity() {
            let i = "",
              _ = 0,
              P,
              M = this.input[this.pos];
            M !== "&" &&
              this.raise(this.pos, "Entity must start with an ampersand");
            let ee = ++this.pos;
            for (; this.pos < this.input.length && _++ < 10; ) {
              if (((M = this.input[this.pos++]), M === ";")) {
                i[0] === "#"
                  ? i[1] === "x"
                    ? ((i = i.substr(2)),
                      l.test(i) && (P = String.fromCharCode(parseInt(i, 16))))
                    : ((i = i.substr(1)),
                      m.test(i) && (P = String.fromCharCode(parseInt(i, 10))))
                  : (P = u[i]);
                break;
              }
              i += M;
            }
            return P || ((this.pos = ee), "&");
          }
          jsx_readWord() {
            let i,
              _ = this.pos;
            ...
            while (L(i) || i === 45);
            return this.finishToken(v.jsxName, this.input.slice(_, this.pos));
          }
          jsx_parseIdentifier() {
          ...
          jsx_parseNamespacedName() {
            let i = this.start,
              _ = this.startLoc,
              P = this.jsx_parseIdentifier();
            if (!g.allowNamespaces || !this.eat(T.colon)) return P;
            var M = this.startNodeAt(i, _);
            return (
              (M.namespace = P),
              (M.name = this.jsx_parseIdentifier()),
              this.finishNode(M, "JSXNamespacedName")
            );
          }
          jsx_parseElementName() {
            ...
            let i = this.start,
              _ = this.startLoc,
              P = this.jsx_parseNamespacedName();
            for (
              this.type === T.dot &&
              P.type === "JSXNamespacedName" &&
              !g.allowNamespacedObjects &&
              this.unexpected();
              this.eat(T.dot);

            ) {
              let M = this.startNodeAt(i, _);
              (M.object = P),
                (M.property = this.jsx_parseIdentifier()),
                (P = this.finishNode(M, "JSXMemberExpression"));
            }
            return P;
          }
          ...
          jsx_parseAttribute() {
            ...
            return this.eat(T.braceL)
              ...
              : ((i.name = this.jsx_parseNamespacedName()),
                (i.value = this.eat(T.eq)
                  ? this.jsx_parseAttributeValue()
                  : null),
                this.finishNode(i, "JSXAttribute"));
          }
          jsx_parseOpeningElementAt(i, _) {
            let P = this.startNodeAt(i, _);
            P.attributes = [];
            let M = this.jsx_parseElementName();
            for (
              M && (P.name = M);
              this.type !== T.slash && this.type !== v.jsxTagEnd;

            )
              P.attributes.push(this.jsx_parseAttribute());
            return (
              (P.selfClosing = this.eat(T.slash)),
              this.expect(v.jsxTagEnd),
              this.finishNode(P, M ? "JSXOpeningElement" : "JSXOpeningFragment")
            );
          }
          jsx_parseClosingElementAt(i, _) {
            let P = this.startNodeAt(i, _),
              M = this.jsx_parseElementName();
            return (
              M && (P.name = M),
              this.expect(v.jsxTagEnd),
              this.finishNode(P, M ? "JSXClosingElement" : "JSXClosingFragment")
            );
          }
              ...
              e: for (;;)
                switch (this.type) {
                  case v.jsxTagStart:
                    ...
                    M.push(this.jsx_parseElementAt(i, _));
                    break;
                  case v.jsxText:
                    M.push(this.parseExprAtom());
                    break;
                  case T.braceL:
                    M.push(this.jsx_parseExpressionContainer());
                    break;
                  default:
                    this.unexpected();
                }
          ...
          readToken(i) {
            ...
            if (_ === w) return this.jsx_readToken();
            if (_ === B || _ === I) {
              if (H(i)) return this.jsx_readWord();
              if (i == 62) return ++this.pos, this.finishToken(v.jsxTagEnd);
              if ((i === 34 || i === 39) && _ == B)
          ...
          updateContext(i) {
            if (this.type == T.braceL) {
              ...
              _ == B
                ? this.context.push(q.b_expr)
                : _ == w
                ? this.context.push(q.b_tmpl)
                : super.updateContext(i),
                (this.exprAllowed = !0);
            } else if (this.type === T.slash && i === v.jsxTagStart)
  ...
  _h = Y({
    "src/language-js/parse/acorn.js"(n, o) {
      ...
      function A(N) {
        let { message: T, loc: v } = N;
        if (!v) return N;
        let { line: q, column: B } = v;
        return u(T.replace(/ \(\d+:\d+\)$/, ""), {
          start: { line: q, column: B + 1 },
        });
      }
      var b,
        g = () => {
        ...
        let v = g(),
          ...
          I = v.parse(
            ...
            Object.assign(
              Object.assign({}, y),
              {},
              { sourceType: T, onComment: q, onToken: B }
            )
          );
        return (I.comments = q), (I.tokens = B), I;
      }
      function R(N, T) {
        let v =
  ...
  wh = Y({
    "node_modules/espree/dist/espree.cjs"(n) {
      ...
      function V(p, D) {
        let S = p[0],
          f = p[p.length - 1],
          F = { type: g.Template, value: D.slice(S.start, f.end) };
        return (
          S.loc && (F.loc = { start: S.loc.start, end: f.loc.end }),
          S.range &&
            ((F.start = S.range[0]),
            (F.end = f.range[1]),
            (F.range = [F.start, F.end])),
          F
        );
      }
      function R(p, D) {
      ...
      R.prototype = {
        ...
        translate(p, D) {
          ...
          if (S === f.name)
          ...
          else if (S.label === "jsxText" || S === f.jsxAttrValueToken)
            p.type = g.JSXText;
          else if (S.keyword)
            ...
            (p.type = g.Numeric), (p.value = this._code.slice(p.start, p.end));
          else if (S === f.string)
            D.jsxAttrValueToken
              ? ((D.jsxAttrValueToken = !1), (p.type = g.JSXText))
              : (p.type = g.String),
              (p.value = this._code.slice(p.start, p.end));
          else if (S === f.regexp) {
        ...
        onToken(p, D) {
          let S = this,
            ...
            K = this._tokens;
          function X() {
            F.push(V(S._tokens, S._code)), (S._tokens = []);
          }
          if (p.type === f.eof) {
            this._curlyBrace && F.push(this.translate(this._curlyBrace, D));
            return;
          }
          if (p.type === f.backQuote) {
            this._curlyBrace &&
              (F.push(this.translate(this._curlyBrace, D)),
              (this._curlyBrace = null)),
              K.push(p),
              K.length > 1 && X();
            return;
          ...
          this._curlyBrace &&
            (F.push(this.translate(this._curlyBrace, D)),
            (this._curlyBrace = null)),
            F.push(this.translate(p, D));
        },
      };
      var N = [3, 5, 6, 7, 8, 9, 10, 11, 12, 13];
      function T() {
        return N[N.length - 1];
      }
      function v() {
      ...
      function I(p) {
        let D = q(p.ecmaVersion),
          S = B(p.sourceType),
          f = p.range === !0,
          F = p.loc === !0;
        if (D !== 3 && p.allowReserved)
          throw new Error(
        ...
        let K = D === 3 ? p.allowReserved || "never" : !1,
          X = p.ecmaFeatures || {},
      ...
      var w = Symbol("espree's internal state"),
        C = Symbol("espree's esprimaFinishNode");
      function H(p, D, S, f, F, K) {
        let X = { type: p ? "Block" : "Line", value: D };
        return (
          typeof S == "number" &&
            ((X.start = S), (X.end = f), (X.range = [S, f])),
          typeof F == "object" && (X.loc = { start: F, end: K }),
          X
        );
      }
      var L = () => (p) => {
          let D = Object.assign({}, p.acorn.tokTypes);
          return (
            p.acornJsx && Object.assign(D, p.acornJsx.tokTypes),
            class extends p {
              constructor(f, F) {
                ...
                super(
                  {
                    ...
                    onToken: (ve) => {
                      me && me.onToken(ve, this[w]),
                        ve.type !== D.eof && (this[w].lastToken = ve);
                    },
                    onComment: (ve, pt, ft, Ee, ge, De) => {
                      if (this[w].comments) {
                        let Ue = H(ve, pt, ft, Ee, ge, De);
                        this[w].comments.push(Ue);
                      }
                    },
                  },
                  F
                  ...
                  (this[w] = {
                    originalSourceType: K || X.sourceType,
                    tokens: me ? [] : null,
                    comments: X.comment === !0 ? [] : null,
                    impliedStrict:
                      oe.impliedStrict === !0 && this.options.ecmaVersion >= 5,
              ...
              parse() {
                ...
                if (
                  ...
                  let [K] = F.body;
                  F.range && (F.range[0] = K.range[0]),
                    F.loc && (F.loc.start = K.loc.start),
                    (F.start = K.start);
                }
                return (
                  f.lastToken &&
                  ...
                  this[w].templateElements.forEach((K) => {
                    let oe = K.tail ? 1 : 2;
                    (K.start += -1),
                      (K.end += oe),
                      K.range && ((K.range[0] += -1), (K.range[1] += oe)),
                      K.loc &&
                        ((K.loc.start.column += -1), (K.loc.end.column += oe));
                  }),
                  F
                );
              }
              parseTopLevel(f) {
                return (
                  this[w].impliedStrict && (this.strict = !0),
                  super.parseTopLevel(f)
                );
              }
              raise(f, F) {
                let K = p.acorn.getLineInfo(this.input, f),
                  X = new SyntaxError(F);
                throw (
                  ((X.index = f),
                  (X.lineNumber = K.line),
...
`,
                ...
                this.end > this.start &&
                  (F += " ".concat(this.input.slice(this.start, this.end))),
                  this.raise(this.start, F);
              }
              jsx_readString(f) {
                let F = super.jsx_readString(f);
                return (
                  this.type === D.string && (this[w].jsxAttrValueToken = !0), F
                );
              }
              [C](f) {
                return (
                  f.type === "TemplateElement" &&
                    this[w].templateElements.push(f),
        ...
        _ = {
          ...
          get regular() {
            return (
              this._regular === null && (this._regular = y.Parser.extend(L())),
              this._regular
            );
          },
          get jsx() {
            return (
              this._jsx === null &&
                (this._jsx = y.Parser.extend(A.default(), L())),
              this._jsx
            );
          },
          get(p) {
      ...
      function P(p, D) {
        let S = _.get(D);
        return (
          (!D || D.tokens !== !0) && (D = Object.assign({}, D, { tokens: !0 })),
          new S(D, p).tokenize()
        );
      }
      function M(p, D) {
        let S = _.get(D);
        return new S(D, p).parse();
      }
      var ee = i,
        ae = (function () {
          return b.KEYS;
  ...
  kh = Y({
    "src/language-js/parse/espree.js"(n, o) {
      ...
      function b(V) {
        let { message: R, lineNumber: N, column: T } = V;
        return typeof N != "number"
          ? V
          : u(R, { start: { line: N, column: T } });
      }
      function g(V, R) {
        let N =
            arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
