        ...
        "src/common/end-of-line.js"(exports2, module2) {
          ...
          function countEndOfLineChars(text, eol) {
            ...
            switch (eol) {
              ...
              default:
                throw new Error(
                  'Unexpected "eol" '.concat(JSON.stringify(eol), ".")
                );
            }
                    ...
                    switch (mode) {
                      case MODE_FLAT:
                        if (!shouldRemeasure) {
                          cmds.push([
                            ind,
                            doc2.break ? MODE_BREAK : MODE_FLAT,
                            doc2.contents,
                          ]);
                          break;
                        }
                      case MODE_BREAK: {
                        ...
                        if (
                          !doc2.break &&
                          fits(next, cmds, rem, options, hasLineSuffix)
                        ) {
                          cmds.push(next);
                        } else {
                            ...
                            if (doc2.break) {
                              ...
                              for (
                                ...
                                if (i >= doc2.expandedStates.length) {
                                  ...
                                  if (
                                    fits(cmd, cmds, rem, options, hasLineSuffix)
                                  ) {
                                    cmds.push(cmd);
                                    break;
                                  }
            ...
            function printDoc(doc2, index, parentParts) {
              ...
              if (doc2.type === "if-break") {
                return (
                  ...
                  (doc2.groupId
                    ? (!doc2.flatContents ? ', ""' : "") +
                      ", { groupId: ".concat(printGroupId(doc2.groupId), " }")
                    : "") +
                  ")"
                );
              }
              ...
              if (doc2.type === "fill") {
                return "fill([".concat(
                  doc2.parts.map((part) => printDoc(part)).join(", "),
                  "])"
                );
              }
              ...
              if (doc2.type === "label") {
                return "label("
                  .concat(JSON.stringify(doc2.label), ", ")
                  .concat(printDoc(doc2.contents), ")");
              }
